...
export default function EditDeliveryChallanPage() {
	 ...
	 useEffect(() => {
		 // Simulate loading challan data
		 const loadChallanData = () => {
			 // In a real app, you would fetch this data from an API
			 setCustomerName('John Doe')
			 setPhoneNo('+1 234 567 8900')
			 setChallanNo('DC-001')
			 setChallanDate('2024-01-15')
			 setDeliveryDate('2024-01-16')
			 setStateOfSupply('same')
			 setVehicleNo('MH-12-AB-1234')
			 setDriverName('Rajesh Kumar')
			 setDriverPhone('+91 98765 43210')
			 setDescription('Sample delivery challan description')
			 setTotal('2500.00')
		 ...
		 <div className="min-h-screen bg-gray-50">
			 ...
			 <div className="flex items-center justify-between">
				 <div className="flex items-center space-x-4">
					 ...
					 <span className="text-sm font-medium">Edit Delivery Challan - {challanNo}</span>
				 </div>
				 <div className="flex items-center space-x-4">
		 ...
		 <div className="p-6 space-y-6">
			 <Card>
				 <CardContent className="p-6">
					 ...
					 <div className="space-y-4">
							 <h3 className="text-sm font-medium text-gray-900">Challan Details</h3>
