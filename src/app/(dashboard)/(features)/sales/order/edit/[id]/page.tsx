...
export default function EditSaleOrderPage() {
	 ...
	 useEffect(() => {
		 ...
		 const loadOrderData = () => {
			 ...
			 setPhoneNo('+1 234 567 8900')
			 setOrderNo('SO-001')
			 setOrderDate('2024-01-15')
			 setDueDate('2024-01-30')
			 setStateOfSupply('same')
			 setDescription('Sample order description')
			 setTotal('1500.00')
			 ...
			 setPaymentTypes([
				 ...
				 { id: 'p2', type: 'Bank Transfer', amount: '500.00', referenceNo: 'TXN123456' }
			 ])
		 }
		 ...
		 <div className="min-h-screen bg-gray-50">
			 ...
			 <div className="flex items-center justify-between">
				 <div className="flex items-center space-x-4">
					 ...
					 <span className="text-sm font-medium">Edit Sale Order - {orderNo}</span>
				 </div>
				 <div className="flex items-center space-x-4">
