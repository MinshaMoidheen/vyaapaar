      ...
      <div className="border-b border-border px-4 py-3">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
          <div className="flex items-center space-x-2 md:space-x-4">
            <span className="text-sm md:text-base font-medium">Purchase</span>
          </div>
        </div>
      </div>
          ...
          <CardContent className="p-4 md:p-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
              ...
              <div className="space-y-4">
                <h3 className="text-sm md:text-base font-medium text-foreground">Supplier/Party Details</h3>
                <div>
                  <Label htmlFor="supplierName" className="text-sm md:text-base font-medium">
              ...
              {/* Bill Details */}
              <div className="space-y-4">
                <h3 className="text-sm md:text-base font-medium text-foreground">Bill Details</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                  <div>
                    <Label className="text-sm md:text-base font-medium">Bill Number</Label>
                    <Input
                      value={billNumber}
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0 pt-2">
                ...
                <div className="text-xs md:text-sm font-medium text-foreground">Total payment: {totalPayment}</div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <label htmlFor="image-upload">
                <Button 
                  variant="outline" 
                  size="sm" 
                  className="flex items-center space-x-2 cursor-pointer text-xs md:text-sm"
                  asChild
                >
                  <span>
